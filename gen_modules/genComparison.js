...
function genComparison(originalMatrix, comparisonMatrixes, genObjectTex, genObjectAreas) {
    let object = new genObject;

    for (let i = 0; i < comparisonMatrixes.length; i++) {
        let resultScan = scan(cfg.precisionComparison, originalMatrix, comparisonMatrixes[i], genObjectAreas[i]);
